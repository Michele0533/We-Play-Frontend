...
try{
    ...
    data.forEach(movie=>{
        ...
        // Falls alte Daten kein type haben
...
<button @click="updateStatus(m,'watching')">
...
<button @click="updateStatus(m,'watched')">
...
<button @click="updateStatus(m,'watchlist')">
...
<button @click="updateStatus(m,'rewatch')">
